...
export default function WholeHeader() {
                        ...
                        <div className="col-sm-8  col-lg-8">
                            <ul className="navbar-nav list-unstyled d-flex flex-row gap-3 gap-lg-5 justify-content-center flex-wrap align-items-center mb-0 fw-bold text-uppercase text-dark">
                                ...
                                <li className="nav-item active">
                                    <Link to={'/whole'} className="nav-link">
                                        Dashboard
                                    </Link>
                                </li>
                                <li className="nav-item active">
                                    <Link to={'/whole/products/manage'} className="nav-link">
                                        Products
                                    </Link>
                                </li>
                                <li className="nav-item active">
                                    <Link to={'/whole/requests'} className="nav-link">
                                        REQUESTS
                                    </Link>
                                </li>
                                <li className="nav-item active">
                                    <Link to={'/whole/sales'} className="nav-link">
                                        Sales
                                    </Link>
                                </li>
                                <li className="nav-item active">
                                    <Link to={'/whole/profile'} className="nav-link">
                                        Profile
                                    </Link>
                                </li>
